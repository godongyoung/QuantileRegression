    ...
    tryCatch(
      {
        ...
        for(p0 in c(0.1,0.25,0.5,0.75,0.9)){
          ...
          if(if.short){
            ...
            save(NQR_res_short, file=sprintf('../debugging/NQR_short_%s_%s_sd%s_NKnots%s_mul%s_Xunif.RData',p0,sim_idx,inp.sd,inp.N.Knots,inp.mul))
          }
          else{
          ...
          if(if.NQR_wo_ME){
            ...
            save(NQR_res_woME_short, file=sprintf('../debugging/NQR_woME_short_%s_%s_sd%s_NKnots%s_mul%s_Xunif.RData',p0,sim_idx,inp.sd,inp.N.Knots,inp.mul))
          }
